...
%global packagename expand-brackets
%global enable_tests 1

Name:		nodejs-expand-brackets
Version:	3.0.0
Release:	5%{?dist}
Summary:	Expand POSIX bracket expressions (character classes) in glob patterns

License:	MIT
URL:		https://github.com/micromatch/expand-brackets
...
BuildRequires:	npm(posix-character-classes)
...
* Wed Apr 18 2018 Jared K. Smith <jsmith@fedoraproject.org> - 3.0.0-1
- Update to upstream 3.0.0 release

* Wed Apr 18 2018 Jared K. Smith <jsmith@fedoraproject.org> - 2.1.4-1
