...
%global packagename mdn-data

# Missing dependencies for the tests
%global enable_tests 0

Name:		nodejs-mdn-data
Version:	1.0.0
Release:	8%{?dist}
Summary:	Open Web data by the Mozilla Developer Network
...
cp -pr package.json *.js css/ l10n/ \
...
* Wed Sep 20 2017 Jared Smith <jsmith@fedoraproject.org> - 1.0.0-1
- Initial packaging
