...
# Fixed in http://git.savannah.gnu.org/gitweb/?p=lilypond.git;a=commitdiff;h=d63756608d265d7a99444af1123b7be8a06f3cc2
#Patch2:		lilypond-Fix-out-of-bounds-access-detected-by-D_GLIBCXX_ASSER.patch
Patch3:         py3.patch

Requires:	ghostscript >= 8.15
Obsoletes: 	lilypond-fonts <= 2.12.1-1
Requires:	lilypond-emmentaler-fonts = %{version}-%{release}
Requires:	lilypond-texgyre-cursor-fonts = %{version}-%{release}
Requires:	lilypond-texgyre-heros-fonts = %{version}-%{release}
Requires:	lilypond-texgyre-schola-fonts = %{version}-%{release}
Requires:	lilypond-c059-fonts = %{version}-%{release}
Requires:	lilypond-nimbus-fonts = %{version}-%{release}

Requires:	texlive-tex-gyre

BuildRequires:  gcc-c++
BuildRequires:  t1utils bison flex ImageMagick gettext texlive-tetex
...
BuildRequires:	rsync
BuildRequires:  texlive-tex-gyre texlive-lh texlive-metapost
...
%package texgyre-cursor-fonts
Summary:        Lilypond texgyrecursor fonts
Requires:       fontpackages-filesystem
Requires:	lilypond-fonts-common = %{version}-%{release}
BuildArch:	noarch

%description texgyre-cursor-fonts
LilyPond is an automated music engraving system. It formats music
beautifully and automatically, and has a friendly syntax for its input
files.

These are the texgyrecursor fonts included in the package.

%package texgyre-heros-fonts
Summary:        Lilypond texgyreheros fonts
Requires:       fontpackages-filesystem
Requires:	lilypond-fonts-common = %{version}-%{release}
BuildArch:	noarch

%description texgyre-heros-fonts
LilyPond is an automated music engraving system. It formats music
beautifully and automatically, and has a friendly syntax for its input
files.

These are the texgyreheros fonts included in the package.

%package texgyre-schola-fonts
Summary:        Lilypond texgyreschola fonts
Requires:       fontpackages-filesystem
Requires:	lilypond-fonts-common = %{version}-%{release}
BuildArch:	noarch

%description texgyre-schola-fonts
LilyPond is an automated music engraving system. It formats music
beautifully and automatically, and has a friendly syntax for its input
files.

These are the texgyreschola fonts included in the package.

%package c059-fonts
Summary:        Lilypond C059 fonts
Requires:       fontpackages-filesystem
Requires:	lilypond-fonts-common = %{version}-%{release}
BuildArch:	noarch

%description c059-fonts
LilyPond is an automated music engraving system. It formats music
beautifully and automatically, and has a friendly syntax for its input
files.

These are the C059 fonts included in the package.

%package nimbus-fonts
Summary:        Lilypond Nimbus fonts
Requires:       fontpackages-filesystem
Requires:	lilypond-fonts-common = %{version}-%{release}
BuildArch:	noarch

%description nimbus-fonts
LilyPond is an automated music engraving system. It formats music
beautifully and automatically, and has a friendly syntax for its input
files.

These are the Nimbus fonts included in the package.
...
Obsoletes:	lilypond-century-schoolbook-l-fonts <= 2.19.26-2
BuildArch:	noarch
...
%_font_pkg -n texgyre-cursor texgyrecursor*otf
%_font_pkg -n texgyre-heros texgyreheros*otf
%_font_pkg -n texgyre-schola texgyreschola*otf
%_font_pkg -n c059 C059*otf
%_font_pkg -n nimbus Nimbus*otf
