...
%global packagename stream-each
%global enable_tests 1

Name:		nodejs-stream-each
Version:	1.2.0
Release:	6%{?dist}
Summary:	Iterate all the data in a stream
...
* Sun Sep 24 2017 Jared Smith <jsmith@fedoraproject.org> - 1.2.0-1
- Initial packaging
