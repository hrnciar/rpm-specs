...
%global packagename commondir
%global enable_tests 1

Name:		nodejs-commondir
Version:	1.0.1
Release:	10%{?dist}
Summary:	Compute the closest common parent for file paths
...
* Thu Feb 11 2016 Jared Smith <jsmith@fedoraproject.org> - 1.0.1-1
- Initial packaging
