...
%global gitrev d1469ab
%global gitstring %{gitdate}git%{gitrev}
...
# mv qstat qstat-2.15
# tar cvfj qstat-2.15-20200131gitd1469ab.tar.bz2 qstat-2.15
Source0: qstat-%{version}-%{gitstring}.tar.bz2
