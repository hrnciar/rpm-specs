...
URL:            https://www.woodsidelabs.com/chemistry/xdrawchem.php
License:	GPLv2+
BuildRequires:  gcc-c++
...
desktop-file-install \
	...
	%{SOURCE1}
pushd %{buildroot}%{_datadir}/xdrawchem
rm \
        caslist.txt \
        CMakeLists.txt \
        COPYRIGHT.txt \
