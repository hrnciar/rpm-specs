...
Source:        https://github.com/boundary/%{master}/archive/%{name}-%{version}-boundary-20181005.zip
...
%{?python_provide:%python_provide python3-libdnet}
# Remove before F30
