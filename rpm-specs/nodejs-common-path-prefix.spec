...
%global packagename common-path-prefix

# tests missing due to missing npm(ava)
%global enable_tests 0

Name:		nodejs-common-path-prefix
Version:	1.0.0
Release:	8%{?dist}
Summary:	Computes the longest prefix string that is common to each path

License:	ISC
URL:		https://github.com/novemberborn/common-path-prefix
Source0:	https://registry.npmjs.org/%{packagename}/-/%{packagename}-%{version}.tgz
# The test files are not included in the npm tarball.
Source1:	https://raw.githubusercontent.com/novemberborn/common-path-prefix/v%{version}/test.js
