...
Source0:        ftp://ftp.gnutls.org/gcrypt/gnutls/v3.6/gnutls-%{version}.tar.xz
Source1:        ftp://ftp.gnutls.org/gcrypt/gnutls/v3.6/gnutls-%{version}.tar.xz.sig
...
BuildRequires:  mingw32-nettle >= 3.4.1
...
BuildRequires:  mingw64-nettle >= 3.4.1
