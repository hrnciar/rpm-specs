...
#
appstream-util replace-screenshots $RPM_BUILD_ROOT%{_datadir}/metainfo/rhythmbox.appdata.xml \
...
%{_datadir}/icons/hicolor/scalable/apps/org.gnome.Rhythmbox-symbolic.svg
