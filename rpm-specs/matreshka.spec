...
%install
make install DESTDIR=%{buildroot} LIBDIR=%{_libdir} PREFIX=%{_prefix} GPRDIR=%{_gprdir} BINDIR=%{_bindir} AWS_BUILD=relocatable
## Delete rpath
...
* Tue Aug 13 2019 Pavel Zhukov <pzhukov@redhat.com> - 18.1-6
- Fix mysql libs parser

* Thu Jul 25 2019 Fedora Release Engineering <releng@fedoraproject.org> - 18.1-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_31_Mass_Rebuild

* Mon Mar 03 2019 Pavel Zhukov <pzhukov@redhat.com> - 18.1-4
- Björn Persson: Disabled armv7hl because of a GCC bug.


* Fri Feb 01 2019 Fedora Release Engineering <releng@fedoraproject.org> - 18.1-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_30_Mass_Rebuild

* Wed Oct 24 2018 Reznik <reznikmm@gmail.com> - 18.0-1
- Update to 18.0 version

* Fri Jul 13 2018 Fedora Release Engineering <releng@fedoraproject.org> - 0.8.0-12.20170302svn
- Rebuilt for https://fedoraproject.org/wiki/Fedora_29_Mass_Rebuild

* Tue Feb 06 2018 Pavel Zhukov <landgraf@fedoraproject.org - 0.8.0-11.20170302svn
- rebuilt
