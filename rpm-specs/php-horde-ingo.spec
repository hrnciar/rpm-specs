...
for cmd in php php56 php70 php71 php72; do
  if which $cmd; then
    if   $cmd %{_bindir}/phpunit --atleast-version 4
    then $cmd %{_bindir}/phpunit --verbose .
...
* Thu Jan 30 2020 Fedora Release Engineering <releng@fedoraproject.org> - 3.2.16-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_32_Mass_Rebuild

* Fri Jul 26 2019 Fedora Release Engineering <releng@fedoraproject.org> - 3.2.16-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_31_Mass_Rebuild

* Sat Feb 02 2019 Fedora Release Engineering <releng@fedoraproject.org> - 3.2.16-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_30_Mass_Rebuild

* Fri Jul 13 2018 Fedora Release Engineering <releng@fedoraproject.org> - 3.2.16-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_29_Mass_Rebuild

* Fri Feb 09 2018 Fedora Release Engineering <releng@fedoraproject.org> - 3.2.16-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_28_Mass_Rebuild

* Tue Sep 19 2017 Remi Collet <remi@remirepo.net> - 3.2.16-1
- Update to 3.2.16 (no change)

* Thu Jul 27 2017 Fedora Release Engineering <releng@fedoraproject.org> - 3.2.15-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_27_Mass_Rebuild

* Wed May  3 2017 Remi Collet <remi@remirepo.net> - 3.2.15-1
- Update to 3.2.15

* Mon Mar 20 2017 Remi Collet <remi@remirepo.net> - 3.2.14-1
- Update to 3.2.14

* Sat Feb 11 2017 Fedora Release Engineering <releng@fedoraproject.org> - 3.2.13-3
...
* Tue Feb  9 2016 Remi Collet <remi@fedoraproject.org> - 3.2.8-1
- Update to 3.2.8
...
* Thu Jun 18 2015 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 3.2.5-2
...
* Wed Jul 23 2014 Remi Collet <remi@fedoraproject.org> - 3.2.0-1
- Update to 3.2.0
- raise dep on Hode_Core
- run test suite during build when possible
