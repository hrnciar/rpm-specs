...
Requires:      (php-pear(%{pear_channel}/Horde_Alarm)           >= 2.1.0   with php-pear(%{pear_channel}/Horde_Alarm)           <  3)
Requires:      (php-pear(%{pear_channel}/Horde_Argv)            >= 2.0.0   with php-pear(%{pear_channel}/Horde_Argv)            <  3)
...
Requires:      (php-pear(%{pear_channel}/Horde_Form)            >= 2.0.16  with php-pear(%{pear_channel}/Horde_Form)            <  3)
...
Requires:      (php-pear(%{pear_channel}/Horde_Perms)           >= 2.1.5   with php-pear(%{pear_channel}/Horde_Perms)           <  3)
...
# Optional
Recommends:     php-pear(File_Find)
Recommends:     php-pear(File_Fstab)
Recommends:     php-pear(Console_Getopt)
Recommends:     php-pear(Console_Table)
Recommends:     php-pear(Net_DNS2)
Recommends:    (php-pear(%{pear_channel}/Horde_Db)              >= 2.0.0   with php-pear(%{pear_channel}/Horde_Db)              <  3)
Recommends:    (php-pear(%{pear_channel}/Horde_Feed)            >= 2.0.0   with php-pear(%{pear_channel}/Horde_Feed)            <  3)
Recommends:    (php-pear(%{pear_channel}/Horde_Oauth)           >= 2.0.0   with php-pear(%{pear_channel}/Horde_Oauth)           <  3)
Recommends:    (php-pear(%{pear_channel}/Horde_OpenXchange)     >= 1.0.0   with php-pear(%{pear_channel}/Horde_OpenXchange)     <  2)
Recommends:    (php-pear(%{pear_channel}/Horde_Service_Weather) >= 2.2.0   with php-pear(%{pear_channel}/Horde_Service_Weather) <  3)
...
* Tue Jun  2 2020 Remi Collet <remi@remirepo.net> - 5.2.22-2
- requires php(httpd)

* Tue Apr 21 2020 Remi Collet <remi@remirepo.net> - 5.2.22-1
- update to 5.2.22

* Thu Jan 30 2020 Fedora Release Engineering <releng@fedoraproject.org> - 5.2.21-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_32_Mass_Rebuild

* Fri Jul 26 2019 Fedora Release Engineering <releng@fedoraproject.org> - 5.2.21-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_31_Mass_Rebuild

* Tue Apr 23 2019 Remi Collet <remi@remirepo.net> - 5.2.21-1
- update to 5.2.21
- use range dependencies

* Sat Feb 02 2019 Fedora Release Engineering <releng@fedoraproject.org> - 5.2.20-2
...
* Fri Jul 13 2018 Fedora Release Engineering <releng@fedoraproject.org> - 5.2.18-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_29_Mass_Rebuild

* Thu Jul  5 2018 Remi Collet <remi@remirepo.net> - 5.2.18-1
- update to 5.2.18

* Fri Feb 09 2018 Fedora Release Engineering <releng@fedoraproject.org> - 5.2.17-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_28_Mass_Rebuild

* Tue Sep 19 2017 Remi Collet <remi@remirepo.net> - 5.2.17-1
- Update to 5.2.17

* Tue Aug  1 2017 Remi Collet <remi@remirepo.net> - 5.2.16-1
- Update to 5.2.16

* Thu Jul 27 2017 Fedora Release Engineering <releng@fedoraproject.org> - 5.2.15-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_27_Mass_Rebuild

* Wed May  3 2017 Remi Collet <remi@remirepo.net> - 5.2.15-1
- Update to 5.2.15

* Mon Mar 20 2017 Remi Collet <remi@remirepo.net> - 5.2.14-1
- Update to 5.2.14

* Sat Feb 11 2017 Fedora Release Engineering <releng@fedoraproject.org> - 5.2.13-3
...
* Tue Feb  9 2016 Remi Collet <remi@fedoraproject.org> - 5.2.9-1
- Update to 5.2.9

* Thu Feb 04 2016 Fedora Release Engineering <releng@fedoraproject.org> - 5.2.8-2
...
* Thu Jun 18 2015 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 5.2.5-2
...
* Wed Jul 23 2014 Remi Collet <remi@fedoraproject.org> - 5.2.0-1
- Update to 5.2.0
...
* Sat Jun 07 2014 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 5.1.6-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_21_Mass_Rebuild

* Tue Apr 29 2014 Remi Collet <remi@fedoraproject.org> - 5.1.6-3
