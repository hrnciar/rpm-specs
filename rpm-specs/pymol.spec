...
# Fix shebang in individual files to ensure Python3 dependence
pathfix.py -pn -i "%{__python3}" test/cyg test/run test/show
...
%install
%py3_install -- --use-msgpackc=c++11 --glut --pymol-path=%{python3_sitearch}/%{name}
