...
BuildRequires:  (php-composer(doctrine/instantiator) >= 1.2.0         with php-composer(doctrine/instantiator) <  2)
...
BuildRequires:  (php-composer(phpunit/php-code-coverage) >= 8.0.1     with php-composer(phpunit/php-code-coverage) <  9)
...
BuildRequires:  (php-composer(sebastian/object-enumerator) >= 4.0     with php-composer(sebastian/object-enumerator) <  5)
BuildRequires:  (php-composer(sebastian/resource-operations) >= 3.0   with php-composer(sebastian/resource-operations) < 4)
BuildRequires:  (php-composer(sebastian/type) >= 2.0                  with php-composer(sebastian/type) <  3)
...
Requires:       (php-composer(doctrine/instantiator) >= 1.2.0         with php-composer(doctrine/instantiator) <  2)
...
Requires:       (php-composer(phpunit/php-code-coverage) >= 8.0.1     with php-composer(phpunit/php-code-coverage) <  9)
...
Requires:       (php-composer(sebastian/object-enumerator) >= 4.0     with php-composer(sebastian/object-enumerator) <  5)
Requires:       (php-composer(sebastian/resource-operations) >= 3.0   with php-composer(sebastian/resource-operations) <  4)
Requires:       (php-composer(sebastian/type) >= 2.0                  with php-composer(sebastian/type) <  3)
