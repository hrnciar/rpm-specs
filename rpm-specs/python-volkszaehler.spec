...
Version:        0.1.2
Release:        7%{?dist}
Summary:        A Python Client for interacting with the Volkszahler API

License:        MIT
URL:            https://github.com/fabaff/python-volkszaehler
Source0:        https://github.com/fabaff/python-volkszaehler/archive/%{version}/%{pypi_name}-%{version}.tar.gz
BuildArch:      noarch
