...
%global packagename source-map-resolve
%global enable_tests 1

Name:		nodejs-source-map-resolve
Version:	0.5.0
Release:	8%{?dist}
...
BuildRequires:	npm(simple-asyncify)
...
%{__nodejs} -e 'require("./")'
%if 0%{?enable_tests}
%__nodejs test/source-map-resolve.js && node test/windows.js
%else
...
%changelog
* Sat Aug 01 2020 Fedora Release Engineering <releng@fedoraproject.org> - 0.5.0-8
...
* Fri Apr 14 2017 Jared Smith <jsmith@fedoraproject.org> - 0.5.0-1
- Update to upstream 0.5.0 release

* Fri Oct 23 2015 Jared Smith <jsmith@fedoraproject.org> - 0.4.0-1
- Initial packaging
