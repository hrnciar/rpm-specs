...
# Tests are not packaged with 6.2.1, also it's not tagged.
# git clone https://github.com/ruby/rdoc.git --no-checkout
# cd rdoc && git archive -v -o rdoc-6.2.1-tests.tar.xz c65e14d1 test/
...
# Required in /usr/share/rubygems/rubygems/test_case.rb:29
...
RUBYOPT=-Ilib \
ruby -Itest -e 'Dir.glob "./test/**/test_*.rb", &method(:require)' -- -v
popd
