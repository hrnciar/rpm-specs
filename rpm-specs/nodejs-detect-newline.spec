...
%global packagename detect-newline

# tests disabled due to missing npm(ava)
%global enable_tests 0

Name:		nodejs-detect-newline
Version:	2.1.0
Release:	8%{?dist}
Summary:	Detect the dominant newline character of a string

License:	MIT
URL:		https://github.com/sindresorhus/detect-newline
Source0:	https://registry.npmjs.org/%{packagename}/-/%{packagename}-%{version}.tgz
# The test files are not included in the npm tarball.
Source1:	https://raw.githubusercontent.com/sindresorhus/detect-newline/v%{version}/test.js
...
* Thu Feb 08 2018 Fedora Release Engineering <releng@fedoraproject.org> - 2.1.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_28_Mass_Rebuild

* Wed Apr 19 2017 Jared Smith <jsmith@fedoraproject.org> - 2.1.0-1
- Initial packaging
