...
%global packagename memoize-path
%global enable_tests 1

Name:		nodejs-memoize-path
Version:	0.1.2
Release:	8%{?dist}
Summary:	Easily create reusable, stackable file paths from memoized path segments

License:	MIT
URL:		https://github.com/jonschlinkert/memoize-path
