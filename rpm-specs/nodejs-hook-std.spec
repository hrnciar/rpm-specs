...
%global packagename hook-std

# tests missing due to missing npm(ava)
%global enable_tests 0

Name:		nodejs-hook-std
Version:	0.4.0
Release:	8%{?dist}
Summary:	Hook and modify stdout/stderr

License:	MIT
URL:		https://github.com/sindresorhus/hook-std
Source0:	https://registry.npmjs.org/%{packagename}/-/%{packagename}-%{version}.tgz
# The test files are not included in the npm tarball.
Source1:	https://raw.githubusercontent.com/sindresorhus/hook-std/v%{version}/test.js
...
%changelog
* Sat Aug 01 2020 Fedora Release Engineering <releng@fedoraproject.org> - 0.4.0-8
...
* Wed Sep 27 2017 Jared Smith <jsmith@fedoraproject.org> - 0.4.0-1
- Update to upstream 0.4.0 release

* Wed Apr 19 2017 Jared Smith <jsmith@fedoraproject.org> - 0.3.0-1
- Initial packaging
