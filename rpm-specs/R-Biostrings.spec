...
BuildRequires:    R-XVector-devel >= 0.27.2, R-BiocGenerics >= 0.31.5, R-S4Vectors-devel >= 0.25.14
BuildRequires:    R-graphics, R-methods, R-stats, R-utils, R-grDevices, R-crayon
