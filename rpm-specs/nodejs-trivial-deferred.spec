...
%global packagename trivial-deferred

# tests need newer npm(tap)
%global enable_tests 0

Name:		nodejs-trivial-deferred
Version:	1.0.1
Release:	8%{?dist}
Summary:	The most dead-simple trivial Deferred implementation

License:	ISC
URL:		https://github.com/isaacs/trivial-deferred
