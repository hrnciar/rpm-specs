...
install -m 0644 -p %{S:3rd/vim/vim/syntax/fluxapps.vim} %{buildroot}%{_datadir}/vim/vimfiles/syntax/fluxapps.vim
install -m 0644 -p %{S:3rd/vim/vim/syntax/fluxkeys.vim} %{buildroot}%{_datadir}/vim/vimfiles/syntax/fluxkeys.vim
install -m 0644 -p %{S:3rd/vim/vim/syntax/fluxmenu.vim} %{buildroot}%{_datadir}/vim/vimfiles/syntax/fluxmenu.vim
