...
Patch0:         0000-drop-patented-zoom-animation.patch

# patch .desktop file to hide the launcher in Pantheon,
# plank is already a default shell component there
Patch1:         0001-hide-app-launcher-in-pantheon.patch

# port to meson, drop autotools (patches from elementaryOS):
# https://github.com/elementary/dock/commit/c210ff9
# https://github.com/elementary/dock/commit/2503060
# https://github.com/elementary/dock/commit/ac87d90
Patch2:         0002-port-to-meson-drop-autotools-support.patch

# register with GNOME session manager for restart support etc.
# (patch from elementaryOS):
# https://github.com/elementary/dock/commit/a8d2f25
Patch3:         0003-register-with-session-manager.patch

# drop ugly TitledSeparatorMenuItem (patch from elementaryOS):
# https://github.com/elementary/dock/commit/9b84ded
Patch4:         0004-drop-ugly-TitledSeparatorMenuItem.patch
