...
Patch0:  sugar-0.116-config-empy-fix.patch
...
%package gtk2
Summary: Sugar artwork gtk2 themes
Requires: gtk2

%description gtk2
sugar-artwork gtk2 contains the themes and icons that make up the Sugar default
look and feel.
