...
Source0:        %pypi_source
# both patches are backports of my upstream PR #27:
#   https://github.com/edgewall/genshi/pull/27
Patch1:         python-genshi-prefer-ast.patch
Patch2:         python-genshi-adapt-to-python39.patch
