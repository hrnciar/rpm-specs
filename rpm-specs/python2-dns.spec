...
Patch1:         switch_to_python_cryptography.patch
...
%changelog
* Tue Aug 04 2020 Lumír Balhar <lbalhar@redhat.com> - 1.16.0-14
- Bump release for rebuild python2-dns after mass rebuild of python-dns

* Thu Jul 23 2020 Lumír Balhar <lbalhar@redhat.com> - 1.16.0-13
- Package forked to python2-dns
