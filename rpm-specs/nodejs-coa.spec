...
%global packagename coa

# tests involving external subcommands are failing, but I can't figure out why
%global enable_tests 0

Name:		nodejs-coa
Version:	2.0.0
Release:	6%{?dist}
Summary:	Command-Option-Argument: Another parser for command line options

License:	MIT
URL:		https://github.com/veged/coa.git
...
sed -i '1s/env //' lib/completion.sh
chmod +x lib/completion.sh
