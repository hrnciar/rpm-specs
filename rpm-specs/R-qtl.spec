...
Version:	1.46.2
Release:	5%{?dist}
Source0:	https://www.rqtl.org/download/%{packname}_1.46-2.tar.gz
License:	GPLv3
URL:		https://www.rqtl.org/
...
%license %{_libdir}/R/library/%{packname}/LICENSE.txt
...
* Fri Jun  5 2020 Tom Callaway <spot@fedoraproject.org> - 1.46.2-2
- rebuild for R 4
