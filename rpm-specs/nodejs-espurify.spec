...
%global packagename espurify
# Tests disabled due to a plethora of unmet dependencies, including the whole
# babel stack
...
License:	MIT
URL:		https://github.com/estools/espurify.git
...
%{__nodejs} -e 'require("./")'
%if 0%{?enable_tests}
NODE_ENV=test %{_bindir}/mocha -R spec test
%else
...
* Wed Apr 19 2017 Jared Smith <jsmith@fedoraproject.org> - 1.7.0-1
- Update to upstream 1.7.0 release

* Tue Jul 05 2016 Jared Smith <jsmith@fedoraproject.org> - 1.6.0-1
- Update to upstream 1.6.0 release

* Tue Nov 10 2015 Jared Smith <jsmith@fedoraproject.org> - 1.3.0-1
- Initial packaging
