...
Source0:        https://gitlab.com/luciocarreras/sayonara-player/-/archive/%{version}-beta6/sayonara-player-%{version}-beta6.tar.bz2
BuildRequires:  cmake
...
%prep
%autosetup -p1 -n %{name}-player-%{version}-beta6
