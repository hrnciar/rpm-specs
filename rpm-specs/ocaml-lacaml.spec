# NB: We can't upgrade to the latest version because it requires some
# OCaml libraries that are not yet packaged in Fedora.
...
install -m 0644 _build/*.cmx $RPM_BUILD_ROOT%{_libdir}/ocaml/lacaml
