...
%global packagename shebang-command

# tests missing due to missing npm(ava)
%global enable_tests 0

Name:		nodejs-shebang-command
Version:	1.2.0
Release:	6%{?dist}
...
Source1:	https://raw.githubusercontent.com/kevva/%{packagename}/v%{version}/test.js
...
* Wed Apr 19 2017 Jared Smith <jsmith@fedoraproject.org> - 1.2.0-1
- Initial packaging
