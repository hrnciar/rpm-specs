...
%global packagename is-path-in-cwd
%global enable_tests 1

Name:		nodejs-is-path-in-cwd
Version:	1.0.0
Release:	10%{?dist}
...
Source1:	https://raw.githubusercontent.com/sindresorhus/is-path-in-cwd/v%{version}/test.js
# The license file is not included in the npm tarball.
Source2:	https://raw.githubusercontent.com/sindresorhus/is-path-in-cwd/v%{version}/license
...
%prep
%setup -q -n package
# setup the test.js and license files
cp -p %{SOURCE1} .
cp -p %{SOURCE2} .
