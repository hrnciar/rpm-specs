...
%global packagename serialize-error
%global enable_tests 0
# tests disabled due to missing npm(ava)

Name:		nodejs-serialize-error
Version:	1.1.0
Release:	10%{?dist}
Summary:	Serialize an error into a plain object

License:	MIT
URL:		https://github.com/sindresorhus/serialize-error
Source0:	https://registry.npmjs.org/%{packagename}/-/%{packagename}-%{version}.tgz
Source1:	https://raw.githubusercontent.com/sindresorhus/serialize-error/v%{version}/test.js
...
%changelog
* Sat Aug 01 2020 Fedora Release Engineering <releng@fedoraproject.org> - 1.1.0-10
