...
%global packagename max-timeout
%global enable_tests 0
# tests disabled due to missing npm(ava)

Name:		nodejs-max-timeout
Version:	1.0.0
Release:	10%{?dist}
Summary:	The max amount of milliseconds you can pass to `setTimeout()`

License:	MIT
URL:		https://github.com/sindresorhus/max-timeout
Source0:	https://registry.npmjs.org/%{packagename}/-/%{packagename}-%{version}.tgz
# The test files are not included in the npm tarball.
Source1:	https://raw.githubusercontent.com/sindresorhus/max-timeout/v1.0.0/test.js
