...
%if 0%{?fedora} >= 28
# Do this only on fedora; definite >= is needed for not having problems to
# build on epel8
# We are not providing -devel -native -native-libs packages anymore,
# so use just "Obsoletes"
...
* Tue Apr 21 2020 Gerd Pokorra <gp@zimt.uni-siegen.de> - 6.0.4-1
- update to 6.0.4
- change RUBYLIBDIR to use ruby_vendorlibdir macro
- exclude architecture armv7hl

* Sat Jan 18 2020 Mamoru TASAKA <mtasaka@fedoraproject.org> - 5.0.30-21
- F-32: rebuild against ruby27

* Thu Nov 14 2019 Björn Esser <besser82@fedoraproject.org> - 5.0.30-20
- Rebuild (jsoncpp)
