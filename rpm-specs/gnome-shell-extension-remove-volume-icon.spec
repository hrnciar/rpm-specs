%global uuid remove-volume-icon@affolter-engineering.ch
%global shortname remove-volume-icon

Name:           gnome-shell-extension-remove-volume-icon
Version:        0.5.1
Release:        13%{?dist}
...
Source0:        http://www.affolter-engineering.ch/uploads/%{shortname}/%{shortname}-%{version}.tar.bz2
BuildArch:      noarch

Requires:       gnome-shell >= 3.2.0

%description
This simple extension does nothing more than to remove the volume 
...
* Fri Apr 13 2012 Fabian Affolter <mail@fabian-affolter.ch> - 0.4.0-1
...
* Mon Jan 02 2012 Fabian Affolter <mail@fabian-affolter.ch> - 0.3.1-1
- Updated to new upstream release 0.3.1

* Sun Nov 13 2011 Fabian Affolter <mail@fabian-affolter.ch> - 0.3-1
