...
Version:	1.0.1
Release:	8%{?dist}
Summary:	ES2015 Math.imul() ponyfill

License:	MIT
URL:		https://github.com/sindresorhus/imul
Source0:	https://registry.npmjs.org/%{packagename}/-/%{packagename}-%{version}.tgz
# The test files are not included in the npm tarball.
Source1:	https://raw.githubusercontent.com/sindresorhus/imul/v%{version}/test.js
...
%changelog
* Sat Aug 01 2020 Fedora Release Engineering <releng@fedoraproject.org> - 1.0.1-8
...
* Tue Oct  3 2017 Jared Smith <jsmith@fedoraproject.org> - 1.0.1-1
- Initial packaging
