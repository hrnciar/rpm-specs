...
%global packagename clone-deep
%global enable_tests 1

Name:		nodejs-clone-deep
Version:	1.0.0
Release:	8%{?dist}
Summary:	Recursively (deep) clone types, like Object, Array, RegExp, Date, primitives
...
BuildRequires:	npm(shallow-clone)
...
* Sat Apr 15 2017 Jared Smith <jsmith@fedoraproject.org> - 0.2.4-1
- Initial packaging
