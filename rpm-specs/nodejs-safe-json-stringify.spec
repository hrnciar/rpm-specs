...
%global packagename safe-json-stringify
%global enable_tests 1

Name:		nodejs-safe-json-stringify
Version:	1.2.0
Release:	5%{?dist}
Summary:	Prevent defined property getters from throwing errors

License:	MIT
# License is in README.md file
...
%{__nodejs} -e 'require("./")'
%if 0%{?enable_tests}
%{_bindir}/tape test/safe-json-stringify-test.js
%else
...
* Thu May 24 2018 Jared K. Smith <jsmith@fedoraproject.org> - 1.2.0-1
...
* Sat Feb 25 2017 Jared Smith <jsmith@fedoraproject.org> - 1.0.3-2
- Fix test tarball in SRPM

* Sat Nov  7 2015 Jared Smith <jsmith@fedoraproject.org> - 1.0.3-1
- Initial packaging
