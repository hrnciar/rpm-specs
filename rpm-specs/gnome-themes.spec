...
rm -rf $RPM_BUILD_ROOT%{_datadir}/themes/HighContrast/
rm -rf $RPM_BUILD_ROOT%{_datadir}/themes/HighContrastInverse/
rm -rf $RPM_BUILD_ROOT%{_datadir}/themes/HighContrastLargePrint/
rm -rf $RPM_BUILD_ROOT%{_datadir}/themes/HighContrastLargePrintInverse
rm -rf $RPM_BUILD_ROOT%{_datadir}/themes/LowContrast/
rm -rf $RPM_BUILD_ROOT%{_datadir}/themes/LowContrastLargePrint
rm -rf $RPM_BUILD_ROOT%{_datadir}/themes/Inverted/
rm -rf $RPM_BUILD_ROOT%{_datadir}/themes/LargePrint
rm -rf $RPM_BUILD_ROOT%{_datadir}/icons/HighContrast/
rm -rf $RPM_BUILD_ROOT%{_datadir}/icons/HighContrastInverse/
rm -rf $RPM_BUILD_ROOT%{_datadir}/icons/HighContrastLargePrint/
rm -rf $RPM_BUILD_ROOT%{_datadir}/icons/HighContrastLargePrintInverse/
rm -rf $RPM_BUILD_ROOT%{_datadir}/icons/HighContrast-SVG/
rm -rf $RPM_BUILD_ROOT%{_datadir}/icons/LargePrint/
