...
%global packagename core-assert
%global enable_tests 1
# Tests disabled due to https://github.com/nodejs/node/issues/3275

Name:		nodejs-core-assert
Version:	0.2.1
Release:	6%{?dist}
Summary:	Node.js `assert` as a standalone module

License:	MIT
URL:		https://github.com/sindresorhus/core-assert.git
...
%if 0%{?enable_tests}
BuildRequires:	npm(buf-compare)
BuildRequires:	npm(is-error)
%endif
...
* Mon Nov  9 2015 Jared Smith <jsmith@fedoraproject.org> - 0.1.1-1
- Initial packaging
