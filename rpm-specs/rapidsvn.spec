...
# Snapshot generated from https://api.github.com/repos/RapidSVN/RapidSVN/tarball
Source0:        RapidSVN-RapidSVN-move_to_github-113-g%{gitsnap}.tar.gz
...
%prep
%setup -q -n RapidSVN-RapidSVN-%{gitsnap}
