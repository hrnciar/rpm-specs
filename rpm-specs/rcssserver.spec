...
BuildRequires:  gcc-c++ autoconf automake libtool boost-devel zlib-devel
...
# Fix rpath
sed -i.rpath -e '/sys_lib_\(dl\)\?search_path_spec/s| /usr/lib| /lib64 /usr/lib64 /usr/lib|' \
    configure
...
%files
%doc AUTHORS ChangeLog COPYING.LESSER NEWS README.md
%{_bindir}/rcss*
%{_libdir}/*.so.*
