...
%global packagename collection-visit
%global enable_tests 1

Name:		nodejs-collection-visit
Version:	1.0.0
Release:	6%{?dist}
Summary:	Visit a method over  items in object, or map visit over objects in array
