...
%global packagename remove-trailing-separator

# tests missing due to missing npm(ava)
%global enable_tests 0

Name:		nodejs-remove-trailing-separator
Version:	1.1.0
Release:	8%{?dist}
Summary:	Removes separators from the end of the string
...
* Sat Sep 23 2017 Jared Smith <jsmith@fedoraproject.org> - 1.1.0-1
