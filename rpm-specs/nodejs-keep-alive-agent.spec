...
%global packagename keep-alive-agent

# Tests disabled because the die horribly
%global enable_tests 0

Name:		nodejs-keep-alive-agent
Version:	0.0.1
Release:	8%{?dist}
Summary:	A keep-alive agent for http and https

License:	MIT
URL:		https://github.com/ceejbot/keep-alive-agent
...
* Fri Sep 29 2017 Jared Smith <jsmith@fedoraproject.org> - 0.0.1-1
- Initial packaging
