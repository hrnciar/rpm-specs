...
%global packagename istanbul-reports

# tests run fine locally, but fail in mock/koji
%global enable_tests 0

Name:		nodejs-istanbul-reports
Version:	1.3.0
Release:	7%{?dist}
Summary:	istanbul reports
...
BuildRequires:	npm(istanbul-lib-report)
...
%{__nodejs} -e 'require("./")'
%if 0%{?enable_tests}
NODE_ENV=test %{_bindir}/mocha -R spec --recursive
%else
...
* Thu Apr 26 2018 Jared K. Smith <jsmith@fedoraproject.org> - 1.3.0-1
- Initial packaging
