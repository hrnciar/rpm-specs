...
Name:           nodejs-postgres-bytea
Version:        2.0.0
Release:        3%{?dist}
Summary:        Postgres bytea parser

License:        MIT
URL:            https://www.npmjs.com/package/postgres-bytea
Source0:        https://github.com/bendrucker/postgres-bytea/archive/v%{version}/%{name}-%{version}.tar.gz
BuildArch:      noarch
...
%prep
%autosetup -n postgres-bytea-%{version}
rm -rf node_modules
...
%install
mkdir -p %{buildroot}%{nodejs_sitelib}/postgres-bytea
cp -pr package.json index.js %{buildroot}%{nodejs_sitelib}/postgres-bytea
%nodejs_symlink_deps
...
* Thu Apr 25 2019 Tom Hughes <tom@compton.nu> - 2.0.0-1
...
* Wed Dec  9 2015 Tom Hughes <tom@compton.nu> - 1.0.0-2
- Enable tests
