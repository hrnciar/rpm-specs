...
# Depends:
# Imports:   R-ellipsis >= 0.2.0, R-digest, R-glue, R-rlang >= 0.4.5
# Suggests:  R-bit64, R-covr, R-crayon, R-dplyr >= 0.8.5, R-generics, R-knitr, R-pillar >= 1.4.4, R-pkgdown, R-rmarkdown, R-testthat >= 2.3.0, R-tibble, R-withr, R-xml2, R-zeallot
# LinkingTo:
# Enhances:
