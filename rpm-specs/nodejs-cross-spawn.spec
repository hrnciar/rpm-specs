...
%global packagename cross-spawn
%global enable_tests 1

Name:		nodejs-cross-spawn
Version:	5.1.0
Release:	6%{?dist}
Summary:	Cross platform child_process#spawn and child_process#spawnSync

License:	MIT
URL:		https://github.com/IndigoUnited/node-cross-spawn.git
...
BuildRequires:	npm(shebang-command)
...
%{__nodejs} -e 'require("./")'
%if 0%{?enable_tests}
%{__nodejs} test/prepare 
NODE_ENV=test %{_bindir}/mocha -R spec -t 10000 --bail test/test
%else
...
* Thu Sep 21 2017 Jared Smith <jsmith@fedoraproject.org> - 5.1.0-1
- Update to upstream 5.1.0 release

* Sat Aug 12 2017 Tom Hughes <tom@compton.nu> - 4.0.0-4
...
* Wed Jul 13 2016 Jared Smith <jsmith@fedoraproject.org> - 4.0.0-1
- Initial packaging
