...
sed -i "s|/usr/bin/env python|/usr/bin/env python2|" docs/zh_tw/mkTuxpaintIM.py
sed -i "s|/usr/bin/env python|/usr/bin/env python2|" fonts/locale/zh_tw_docs/maketuxfont.py
