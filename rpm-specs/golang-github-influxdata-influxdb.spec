...
BuildRequires:  golang(github.com/prometheus/prometheus/storage/tsdb)
...
%prep
%goprep
sed -i "s|github.com/influxdata/promql/v2|github.com/influxdata/promql|" $(find . -type f -iname "*.go")
sed -i "s|github.com/influxdata/influxdb/v2|github.com/influxdata/influxdb|" $(find . -type f -iname "*.go")
sed -i "s|github.com/nats-io/gnatsd|github.com/nats-io/nats-server|" $(find . -type f -iname "*.go")
