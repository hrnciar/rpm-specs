...
Patch0001: 0001-Fix-passing-CFLAGS-to-PHP-configure.patch
...
# RHEL 6 compatibility for PHP
%if 0%{?el6}
%{!?php_inidir:	%{expand: %%global php_inidir %{_sysconfdir}/php.d }}
%endif

# RHEL 6 compatibility for Ruby
%if 0%{?el6}
...
%check
# tests fail on various dists for now
#make check
...
install -p php/remctl.ini %{buildroot}%{php_inidir}/%{ini_name}
