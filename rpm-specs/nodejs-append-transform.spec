...
%global packagename append-transform
%global enable_tests 0
# tests disabled due to missing 'ava' in Fedora

Name:		nodejs-append-transform
Version:	0.4.0
Release:	9%{?dist}
Summary:	Install a transform to `require.extensions` that always runs last
...
BuildRequires:	npm(default-require-extensions)
%if 0%{?enable_tests}
...
* Tue Feb  9 2016 Jared Smith <jsmith@fedoraproject.org> - 0.4.0-1
- Initial packaging
