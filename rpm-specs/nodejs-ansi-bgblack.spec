...
%global packagename ansi-bgblack
%global enable_tests 1

Name:		nodejs-ansi-bgblack
Version:	0.1.1
Release:	6%{?dist}
Summary:	The color bgblack, in ansi

License:	MIT
URL:		https://github.com/jonschlinkert/ansi-bgblack
Source0:	https://registry.npmjs.org/%{packagename}/-/%{packagename}-%{version}.tgz
# The test files are not included in the npm tarball.
Source1:	https://raw.githubusercontent.com/jonschlinkert/ansi-bgblack/master/test.js
