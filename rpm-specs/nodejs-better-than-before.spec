...
%global packagename better-than-before

# tests missing due to missing npm(ava)
%global enable_tests 0

Name:		nodejs-better-than-before
Version:	1.0.0
Release:	7%{?dist}
Summary:	Better setup for tests

License:	MIT
URL:		https://github.com/stevemao/better-than-before
Source0:	https://registry.npmjs.org/%{packagename}/-/%{packagename}-%{version}.tgz
Source1:	https://raw.githubusercontent.com/stevemao/%{packagename}/master/test.js
