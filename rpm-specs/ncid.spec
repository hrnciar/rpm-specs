...
Patch0:     ncid-usrlocal-manpage-fixes.patch

BuildRequires: gcc, libpcap-devel, pcre-devel, libappstream-glib
...
BuildArch:  noarch
Requires:   tcl, tk >= 8.6.8, mailx, nc
...
%build
make %{?_smp_mflags} EXTRA_CFLAGS="$RPM_OPT_FLAGS" libdir
...
%install
make install install-fedora prefix=%{buildroot}/%{_prefix} \
                            prefix2=%{buildroot} \
                            prefix3=%{buildroot}
...
%{_datadir}/applications/net.sourceforge.ncid.desktop
%{_datadir}/metainfo/ncid.appdata.xml
