...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gdk-3.0) >= 3.14
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gdk-3.0) >= 3.16
...
* Sun Apr 28 15:16:18 CEST 2019 Igor Gnatenko <ignatenkobrain@fedoraproject.org> - 0.8.0-1
- Update to 0.8.0
