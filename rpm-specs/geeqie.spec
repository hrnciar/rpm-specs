...
%global gitcommit 26c4dadbf4cdbcc52b5ca66c51d9ad19a6a31938
...
%else
Source0: http://geeqie.org/geeqie-%{version}.tar.xz
%endif

Patch0: 0001-Remove-various-unused-variables.patch
Patch1: 0002-Fix-format-string.patch
Patch2: 0003-Remove-unused-callback-functions.patch
Patch3: 0004-Fix-freeing-of-unitialized-variable.patch
Patch4: 0005-Remove-creation-of-unused-label-object.patch
...
# originally http://geeqie.sf.net
# but geeqie.org is the temporary new home and git server
URL: http://geeqie.org
...
%prep
%autosetup -p1 %{?gitcommit:-n %{name}-%{gitcommitshort}}
