...
# One floating point test fails on 32-bit ARM due to rounding error.  Upstream
# is aware, but is uninterested in fixing the issue.  Disable that test.
%ifarch %{arm}
sed -i '2iraise NotApplicable;' Tests/Succeed/Test174.ML
%endif
...
# bit, for some reason that marker does not always take affect, causing the
