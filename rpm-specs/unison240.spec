...
# Add a small hack to keep it working with new lablgtk.
Patch2:    unison240-gtk.patch
# Various small fixes for OCaml 4.08.
Patch3:    unison240-ocaml408.patch
...
make NATIVE=true UISTYLE=gtk2 THREADS=true OCAMLOPT="ocamlopt -unsafe-string -g"
mv unison unison-gtk

make NATIVE=true UISTYLE=text THREADS=true OCAMLOPT="ocamlopt -unsafe-string -g"
