...
%global packagename passport-http-bearer
%global enable_tests 1

Name:		nodejs-passport-http-bearer
Version:	1.0.1
Release:	8%{?dist}
Summary:	HTTP Bearer authentication strategy for Passport

License:	MIT
URL:		https://github.com/jaredhanson/passport-http-bearer
...
%if 0%{?enable_tests}
# Fix the syntax for the tests
sed -ibak 's/chai.passport(/chai.passport.use(/' test/*.js
%endif
...
%{__nodejs} -e 'require("./")'
%if 0%{?enable_tests}
%{_bindir}/mocha -R spec --require test/bootstrap/node test/*.test.js
%else
...
* Sat Jan  7 2017 Jared Smith <jsmith@fedoraproject.org> - 1.0.1-1
- Initial packaging
