...
# Move to git checkout as version 3.3 is too old for wsjtx.
%global githash 779cd69287b66b5ee7dcb17297975a852836e89f
%global shorthash %(c=%{githash}; echo ${c:0:10})
%global rel_date 20200615
%global rel_string .%{rel_date}git%{shorthash}


Name:           hamlib
Version:        4.0
Release:        0.9%{?dist}%{rel_string}
Summary:        Run-time library to control radio transceivers and receivers

License:        GPLv2+ and LGPLv2+
URL:            http://www.hamlib.org
#Source0:        http://downloads.sourceforge.net/%%{name}/%%{name}-%%{version}%%{?pre:~%%{pre}}.tar.gz
Source0:        https://github.com/Hamlib/Hamlib/archive/%{githash}/%{name}-%{version}%{rel_string}.tar.gz
...
# Remove dir file as install-info updates the system copy
