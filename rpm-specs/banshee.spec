...
* Mon Jul 29 2019 Tom Callaway <spot@fedoraproject.org> - 2.6.2-34
- apply fixes from Fabrice Bellet

* Wed Jul 24 2019 Fedora Release Engineering <releng@fedoraproject.org> - 2.6.2-33
- Rebuilt for https://fedoraproject.org/wiki/Fedora_31_Mass_Rebuild

* Thu Jan 31 2019 Fedora Release Engineering <releng@fedoraproject.org> - 2.6.2-32
- Rebuilt for https://fedoraproject.org/wiki/Fedora_30_Mass_Rebuild

* Thu Jul 12 2018 Fedora Release Engineering <releng@fedoraproject.org> - 2.6.2-31
- Rebuilt for https://fedoraproject.org/wiki/Fedora_29_Mass_Rebuild

* Fri Mar 23 2018 Tom Callaway <spot@fedoraproject.org> - 2.6.2-30
- rebuild

* Wed Feb 07 2018 Fedora Release Engineering <releng@fedoraproject.org> - 2.6.2-29
- Rebuilt for https://fedoraproject.org/wiki/Fedora_28_Mass_Rebuild

* Sun Jan 07 2018 Igor Gnatenko <ignatenkobrain@fedoraproject.org> - 2.6.2-28
- Remove obsolete scriptlets

* Wed Sep  6 2017 Tom Callaway <spot@fedoraproject.org> - 2.6.2-27
- fix .pc files in banshee-devel to have correct deps

* Tue Sep  5 2017 Tom Callaway <spot@fedoraproject.org> - 2.6.2-26
- BUMP

* Wed Aug 30 2017 Tom Callaway <spot@fedoraproject.org> - 2.6.2-25
- Convert failed xml streams from dos2unix and retry

* Wed Aug 02 2017 Fedora Release Engineering <releng@fedoraproject.org> - 2.6.2-24
- Rebuilt for https://fedoraproject.org/wiki/Fedora_27_Binutils_Mass_Rebuild

* Wed Jul 26 2017 Fedora Release Engineering <releng@fedoraproject.org> - 2.6.2-23
- Rebuilt for https://fedoraproject.org/wiki/Fedora_27_Mass_Rebuild

* Sat Jul 22 2017 Tom Callaway <spot@fedoraproject.org> - 2.6.2-22
...
* Tue Jul 18 2017 Tom Callaway <spot@fedoraproject.org> - 2.6.2-21
- fix up cairo warnings
- fix icon warning
- use complete dbus patch from upstream (not new, upstream still dead)

* Mon Mar 20 2017 Tom Callaway <spot@fedoraproject.org> - 2.6.2-20
- rebuild without webkitgtk

* Mon Feb 27 2017 Tom Callaway <spot@fedoraproject.org> - 2.6.2-19
- rebuild for dbus-sharp[-glib]

* Fri Feb 10 2017 Fedora Release Engineering <releng@fedoraproject.org> - 2.6.2-18
- Rebuilt for https://fedoraproject.org/wiki/Fedora_26_Mass_Rebuild

* Tue Oct 25 2016 Tom Callaway <spot@fedoraproject.org> - 2.6.2-17
- rebuild for new gudev-sharp

* Thu Oct 13 2016 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 2.6.2-16
- mono rebuild for aarch64 support

* Fri Feb 12 2016 Tom Callaway <spot@fedoraproject.org> - 2.6.2-15
- fixup sqlite hints patch to do proper version checking and match upstream commit

* Wed Feb 03 2016 Fedora Release Engineering <releng@fedoraproject.org> - 2.6.2-14
