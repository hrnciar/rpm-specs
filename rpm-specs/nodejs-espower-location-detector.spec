...
%global packagename espower-location-detector
%global enable_tests 1

Name:		nodejs-espower-location-detector
Version:	1.0.0
Release:	6%{?dist}
Summary:	AST source location detection helper for power-assert
