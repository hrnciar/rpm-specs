...
%global packagename check-error
%global enable_tests 1

Name:		nodejs-check-error
Version:	1.0.2
Release:	5%{?dist}
Summary:	Error comparison and information related utility for node and the browser

License:	MIT
URL:		https://github.com/chaijs/check-error.git
...
Patch0:		nodejs-check-error_fix-tests.patch
...
* Tue Apr 24 2018 Jared K. Smith <jsmith@fedoraproject.org> - 1.0.2-1
- Initial packaging
