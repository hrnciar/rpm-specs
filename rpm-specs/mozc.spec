...
Patch5:		mozc-new-era.patch
Patch6:		mozc-python3.patch
# https://github.com/google/mozc/issues/460
Patch7:		mozc-protobuf.patch
...
%patch4 -p1 -b .4-stdc
%patch5 -p1 -b .5-new-era
%patch6 -p1 -b .6-py3
%patch7 -p0 -b .7-protobuf
...
GYP_DEFINES="use_libprotobuf=1 %{?with_zinnia:use_libzinnia=1 zinnia_model_file=/usr/share/zinnia/model/tomoe/handwriting-ja.model} %{!?with_zinnia:use_libzinnia=0} ibus_mozc_path=%{_libexecdir}/ibus-engine-mozc ibus_mozc_icon_path=%{_datadir}/ibus-mozc/product_icon.png" python build_mozc.py gyp --gypdir=%{_bindir} --server_dir=%{_libexecdir}/mozc --target_platform=Linux %{!?with_qt:--noqt}
