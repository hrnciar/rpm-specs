...
# rm -rf *.exe *.dll
# cd ..
# mv trunk alienarena-7.71.1-svn5663
# tar --exclude-vcs -cJf alienarena-7.71.1-svn5663.tar.xz alienarena-7.71.1-svn5663
Source0:	alienarena-7.71.1-svn5663.tar.xz
Source1:	%{name}.desktop
Source2:	GPL.acebot.txt
Source3:	alienarena.appdata.xml
Patch3:		alienarena-7.66-no-qglBlitFramebufferEXT.patch
Patch5:		alienarena-7.71.1-svn5663-system-ode-double.patch
...
%prep
%setup -q -n %{name}-%{version}-svn5663
