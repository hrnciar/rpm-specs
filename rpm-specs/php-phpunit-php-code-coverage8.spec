# remirepo/fedora spec file for php-phpunit-php-code-coverage8
#
...
BuildRequires:  (php-composer(sebastian/code-unit-reverse-lookup) >= 2.0   with php-composer(sebastian/code-unit-reverse-lookup) < 3)
BuildRequires:  (php-composer(sebastian/environment)              >= 5.0   with php-composer(sebastian/environment)              < 6)
...
Requires:       (php-composer(sebastian/code-unit-reverse-lookup) >= 2.0   with php-composer(sebastian/code-unit-reverse-lookup) < 3)
Requires:       (php-composer(sebastian/environment)              >= 5.0   with php-composer(sebastian/environment)              < 6)
