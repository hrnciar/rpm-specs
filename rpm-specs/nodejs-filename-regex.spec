...
%global packagename filename-regex
%global enable_tests 1

Name:		nodejs-filename-regex
Version:	2.0.0
Release:	8%{?dist}
Summary:	Regular expression for matching file names

License:	MIT
URL:		https://github.com/regexps/filename-regex.git
Source0:	https://registry.npmjs.org/%{packagename}/-/%{packagename}-%{version}.tgz
# The test files are not included in the npm tarball.
Source1:	https://raw.githubusercontent.com/regexps/%{packagename}/%{version}/test.js
# The LICENSE file is not in the npm tarball.
Source2:	https://raw.githubusercontent.com/regexps/filename-regex/%{version}/LICENSE
