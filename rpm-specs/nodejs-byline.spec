...
Version:	5.0.0
Release:	6%{?dist}
Summary:	Simple line-by-line stream reader
...
%{__nodejs} -e 'require("./")'
%if 0%{?enable_tests}
%{_bindir}/mocha -R spec --timeout 60000
%else
...
* Fri May  5 2017 Jared Smith <jsmith@fedoraproject.org> - 5.0.0-1
- Initial packaging
