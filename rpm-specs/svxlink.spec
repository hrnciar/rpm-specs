...
%define qtel_version 1.2.4
%define server_version 1.6.1
%define reflector_version 1.0.1
...
Source1:	https://github.com/sm0svx/svxlink-sounds-en_US-heather/releases/download/18.03.1/%{name}-sounds-en_US-heather-16k-18.03.1.tar.bz2
...
rm %{buildroot}%{_docdir}/svxlink/man/man1/*html*
rm %{buildroot}%{_docdir}/svxlink/man/man5/*html*
