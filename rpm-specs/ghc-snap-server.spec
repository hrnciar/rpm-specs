...
# testsuite missing deps: http-common http-streams test-framework test-framework-hunit test-framework-quickcheck2
...
%setup -q -n %{pkgver} -a1
chmod a-x CONTRIBUTORS README.SNAP.md README.md
# End cabal-rpm setup
