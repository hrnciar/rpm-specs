...
# https://github.com/mbunkus/mkvtoolnix/issues/1094
...
rm %{buildroot}%{_datadir}/%{name}/sounds/finished-{1,2,3}.ogg
ln -s ../../sounds/Oxygen-K3B-Insert-Medium.ogg  %{buildroot}%{_datadir}/%{name}/sounds/finished-1.ogg
ln -s ../../sounds/Oxygen-K3B-Finish-Success.ogg %{buildroot}%{_datadir}/%{name}/sounds/finished-2.ogg
ln -s ../../sounds/Oxygen-K3B-Finish-Error.ogg   %{buildroot}%{_datadir}/%{name}/sounds/finished-3.ogg
