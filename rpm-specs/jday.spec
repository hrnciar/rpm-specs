...
* Mon Dec 30 2019 Michael Schwendt <mschwendt@fedoraproject.org> - 2.4-23
- explicitly conflicts with netatalk package
- add %%_isa in -devel base pkg dep
- %%install section removes buildroot automatically
- include man page with glob
