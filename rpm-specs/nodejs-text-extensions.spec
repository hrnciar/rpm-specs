...
%global packagename text-extensions

# tests missing due to missing npm(ava)
%global enable_tests 0

Name:		nodejs-text-extensions
Version:	1.7.0
Release:	8%{?dist}
Summary:	List of text file extensions

License:	MIT
URL:		https://github.com/sindresorhus/text-extensions
...
cp -pr package.json text-extensions.json \
...
%changelog
* Sat Aug 01 2020 Fedora Release Engineering <releng@fedoraproject.org> - 1.7.0-8
...
* Tue Oct 03 2017 Jared Smith <jsmith@fedoraproject.org> - 1.7.0-1
- Update to upstream 1.7.0 release

* Wed Sep 06 2017 Jared Smith <jsmith@fedoraproject.org> - 1.6.0-1
- Update to upstream 1.6.0 release

* Thu Jul 27 2017 Fedora Release Engineering <releng@fedoraproject.org> - 1.5.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_27_Mass_Rebuild

* Tue Jun 06 2017 Fedora Release Monitoring  <release-monitoring@fedoraproject.org> - 1.5.0-1
- Update to 1.5.0 (#1459150)

* Sat May  6 2017 Jared Smith <jsmith@fedoraproject.org> - 1.4.0-1
- Initial packaging
