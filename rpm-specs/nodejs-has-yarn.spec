...
%global packagename has-yarn

# tests missing due to missing npm(ava)
%global enable_tests 0

Name:		nodejs-has-yarn
Version:	1.0.0
Release:	9%{?dist}
Summary:	Check if a project is using Yarn

License:	MIT
URL:		https://github.com/sindresorhus/has-yarn
Source0:	https://registry.npmjs.org/%{packagename}/-/%{packagename}-%{version}.tgz
# The test files are not included in the npm tarball.
# Source1 is generated by running Source10, which pulls from the upstream
# version control repository.
Source1:	fixtures-%{version}.tar.bz2
Source10:	dl-tests.sh
# The test.js file isn't in the tarball either
Source11:	https://raw.githubusercontent.com/sindresorhus/has-yarn/v%{version}/test.js
