...
Source0: http://data.nublado.org/cloudy_releases/c13/c%{version}.tar.gz

Obsoletes: cloudy <  08.00-10
Obsoletes: cloudy-devel <  08.00-10
Obsoletes: cloudy-devel-doc <  08.00-10
...
%prep
%setup -q -n c%{version}
rm data/chianti/mn/mn_8/.meo.swp
...
install -m 755 source/cloudy.exe %{buildroot}/%{_bindir}
...
%{buildroot}/%{_bindir}/cloudy.exe -r test
