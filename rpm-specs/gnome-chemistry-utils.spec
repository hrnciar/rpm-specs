...
BuildRequires:  pkgconfig(openbabel-2.0) >= 2.3.0
...
for app_id in gchem3d gchemcalc gchempaint gchemtable gcrystal gspectrum; do
    echo $app_id
    mv $RPM_BUILD_ROOT%{_datadir}/applications/$app_id-0.14.desktop \
...
%{_bindir}/gchem3d
%{_datadir}/appdata/gchem3d.appdata.xml
...
%{_bindir}/gchemcalc
%{_datadir}/appdata/gchemcalc.appdata.xml
...
%{_bindir}/gchempaint
%{_datadir}/appdata/gchempaint.appdata.xml
...
%{_bindir}/gchemtable
%{_datadir}/appdata/gchemtable.appdata.xml
...
%{_bindir}/gcrystal
%{_datadir}/appdata/gcrystal.appdata.xml
...
%{_bindir}/gspectrum
%{_datadir}/appdata/gspectrum.appdata.xml
