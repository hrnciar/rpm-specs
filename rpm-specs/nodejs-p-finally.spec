...
%global packagename p-finally

# tests missing due to missing npm(ava)
%global enable_tests 0

Name:		nodejs-p-finally
Version:	1.0.0
Release:	9%{?dist}
Summary:	Promise#finally() ponyfill - Invoked when the promise is settled

License:	MIT
URL:		https://github.com/sindresorhus/p-finally
Source0:	https://registry.npmjs.org/%{packagename}/-/%{packagename}-%{version}.tgz
# The test files are not included in the npm tarball.
Source1:	https://raw.githubusercontent.com/sindresorhus/p-finally/v1.0.0/test.js
