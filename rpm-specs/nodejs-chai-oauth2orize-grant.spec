...
%global packagename chai-oauth2orize-grant
%global enable_tests 1

Name:		nodejs-chai-oauth2orize-grant
Version:	0.3.0
Release:	8%{?dist}
Summary:	Helpers for testing OAuth2orize grants with the Chai assertion library
...
%{__nodejs} -e 'require("./")'
%if 0%{?enable_tests}
%{_bindir}/mocha --reporter spec --require test/bootstrap/node test/*.test.js
%else
...
%changelog
* Sat Aug 01 2020 Fedora Release Engineering <releng@fedoraproject.org> - 0.3.0-8
...
* Sat Jan  7 2017 Jared Smith <jsmith@fedoraproject.org> - 0.2.1-1
- Initial packaging
