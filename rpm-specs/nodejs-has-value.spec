...
%global packagename has-value
%global enable_tests 1

Name:		nodejs-has-value
Version:	1.0.0
Release:	8%{?dist}
Summary:	Returns true if a value exists, false if empty
...
* Wed May 10 2017 Jared Smith <jsmith@fedoraproject.org> - 0.3.1-2
- Relax version of npm(isobject)

* Fri Apr 14 2017 Jared Smith <jsmith@fedoraproject.org> - 0.3.1-1
- Initial packaging
