...
%global packagename hex-to-array-buffer
%global enable_tests 1

Name:		nodejs-hex-to-array-buffer
Version:	0.1.0
Release:	6%{?dist}
Summary:	Turn a string of hexadecimal characters into an `ArrayBuffer`

License:	MIT
URL:		https://github.com/linusu/hex-to-array-buffer
Source0:	https://registry.npmjs.org/%{packagename}/-/%{packagename}-%{version}.tgz
# license file requested at https://github.com/LinusU/hex-to-array-buffer/issues/2
