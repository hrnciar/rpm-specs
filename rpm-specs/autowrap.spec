# Tests are included by downloading autowrap commits from github
%global with_tests 0
...
rm -rf autowrap-%{version}/autowrap/data_files/boost

%if 0%{?with_python3_other}
cp -a autowrap-%{version} python%{python3_other_pkgversion}
%endif

%build
pushd autowrap-%{version}
%py3_build
popd
...
%license autowrap-%{version}/LICENSE
%{_bindir}/autowrap
