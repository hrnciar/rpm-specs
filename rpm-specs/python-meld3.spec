...
%{srcname} is an HTML/XML templating system for Python 3.4+ which keeps
...
* Wed Oct 02 2019 Francisco Javier Tsao Santín <tsao@gpul.org> - 2.0.0-1
- Upgraded to 2.0.0 version
