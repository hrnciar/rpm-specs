...
BuildRequires:  python2-digitalocean >= 1.11
...
Requires:       python2-digitalocean >= 1.11
...
%license LICENSE.txt
%doc README.rst
%{python2_sitelib}/certbot_dns_digitalocean
%{python2_sitelib}/certbot_dns_digitalocean-%{version}*.egg-info
%endif
