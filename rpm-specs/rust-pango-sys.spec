...
%package     -n %{name}+v1_36_7-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+v1_36_7-devel %{_description}

This package contains library source intended for building other packages
which use "v1_36_7" feature of "%{crate}" crate.

%files       -n %{name}+v1_36_7-devel
%ghost %{cargo_registry}/%{crate}-%{version_no_tilde}/Cargo.toml

%package     -n %{name}+v1_38-devel
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(pango) >= 1.38

%description -n %{name}+v1_38-devel %{_description}

This package contains library source intended for building other packages
which use "v1_38" feature of "%{crate}" crate.

%files       -n %{name}+v1_38-devel
%ghost %{cargo_registry}/%{crate}-%{version_no_tilde}/Cargo.toml
...
This package contains library source intended for building other packages
which use "v1_42" feature of "%{crate}" crate.
