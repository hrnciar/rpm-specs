...
%global packagename auto-bind

# tests missing due to missing npm(ava)
%global enable_tests 0

Name:		nodejs-auto-bind
Version:	1.1.0
Release:	8%{?dist}
Summary:	Automatically bind methods to their class instance

License:	MIT
URL:		https://github.com/sindresorhus/auto-bind
Source0:	https://registry.npmjs.org/%{packagename}/-/%{packagename}-%{version}.tgz
# The test files are not included in the npm tarball.
Source1:	https://raw.githubusercontent.com/sindresorhus/auto-bind/v%{version}/test.js
...
* Wed Apr 19 2017 Jared Smith <jsmith@fedoraproject.org> - 1.1.0-1
- Initial packaging
