...
%global modname  ldap-authentication
...
# backported from http://hg.tryton.org/modules/ldap_authentication/rev/8f97c00cb134
Patch0:         %{modname}-ldap3.patch
# backported from http://hg.tryton.org/modules/ldap_authentication/rev/1bb7086e6a2a
Patch1:         %{modname}-python3.patch
...
* Sun Aug 07 2016 Dan Horák <dan@danny.cz> - 4.0.1-1
- new upstream version 4.0.1
- backported ldap3 and python3 support
