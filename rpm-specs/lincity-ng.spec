...
%global commit 7f266b1a342e0ba4d34e734ee93029f33b97c69a
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global commitdate 20160605
...
Source0:	https://github.com/lincity-ng/%{name}/archive/%{commit}.tar.gz#/%{name}-%{shortcommit}.tar.gz
Patch0:		lincity-ng-fix-int-overflow-in-tech_bonus-calculation.patch
Patch1:		lincity-ng-deprecated-auto_ptr.patch
Patch2:		lincity-ng-c++14.patch
# https://github.com/lincity-ng/lincity-ng/commit/e35110e55ac4537736cc59a14b3d7693893b5199
Patch3:		lincity-ng-fix-ConstructionGroup-destructor.patch
# https://github.com/lincity-ng/lincity-ng/commit/35ffbacb5308a8e825fd737bd08d95032d6c4c8c
Patch4:		lincity-ng-init-all-config-options.patch
# use PHYSFS_getLastErrorCode() and PHYSFS_getErrorByCode instead of deprecated
# PHYSFS_getLastError()
Patch5:		lincity-ng-PHYSFS-use-getErrorByCode.patch
# use PHYSFS_readBytes and PHYSFS_writeBytes instead of
# deprecated PHYSFS_read and PHYSFS_write
Patch6:		lincity-ng-PHYSFS-readwriteBytes.patch
# use PHYSFS_getPrefDir instead of
# deprecated PHYSFS_getUserDir
Patch7:		lincity-ng-PHYSFS-getPrefDir.patch
# use PHYSFS_stat instead of
# deprecated PHYSFS_isDirectory
Patch8:         lincity-ng-PHYSFS-stat.patch
# use PHYSFS_stat instead of
# deprecated PHYSFS_getLastModTime
Patch9:		lincity-ng-PHYSFS-remove-getLastModTime.patch
# use PHYSFS_mount instead of
# deprecated PHYSFS_addToSearchPath
Patch10:	lincity-ng-PHYSFS-remove-addToSearchPath.patch
