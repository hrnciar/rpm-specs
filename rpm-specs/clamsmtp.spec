...
%post
%systemd_post clamsmtpd-clamd.service
%systemd_post clamsmtpd.service

%preun
%systemd_preun clamsmtpd-clamd.service
%systemd_preun clamsmtpd.service

%postun
%systemd_postun_with_restart clamsmtpd-clamd.service
%systemd_postun_with_restart clamsmtpd.service
