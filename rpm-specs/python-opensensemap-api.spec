...
Version:        0.1.5
Release:        7%{?dist}
Summary:        A Python Client for interacting with the openSenseMap API

License:        MIT
URL:            https://github.com/fabaff/python-opensensemap-api
Source0:        https://github.com/fabaff/python-opensensemap-api/archive/%{version}/%{pypi_name}-%{version}.tar.gz
BuildArch:      noarch
