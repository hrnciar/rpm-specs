...
# we need remove patch for file beautify_style.sh because file is not in ufraw-0.22.tar.gz from sourceforge
Patch1: https://github.com/sergiomb2/ufraw/compare/ufraw-0-22..c65b4237dcb430fb274e4778afaf5df9a18e04e6.diff
BuildRequires: gcc
BuildRequires: gcc-c++
