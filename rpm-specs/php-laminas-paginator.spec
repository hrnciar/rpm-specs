...
#
%global bootstrap    0
%global gh_commit    ffc8ffc115375522334e039972169f1c226b4f7d
...
BuildRequires: (php-autoloader(%{gh_owner}/laminas-db)                   >= 2.9.2   with php-autoloader(%{gh_owner}/laminas-db)                   <  3)
