...
Patch7:         libarchive-3.3.3-covscan-2018.patch
...
%patch0 -p1 -b.openssl
%patch1 -p1 -b.cve-2019-1000019
%patch2 -p1 -b.cve-2019-1000020
%patch3 -p1 -b.cve-2018-1000877
%patch4 -p1 -b.cve-2018-1000878
%patch5 -p1 -b.cve-2018-1000879
%patch6 -p1 -b.cve-2018-1000880
%patch7 -p1 -b.covscan-2018
