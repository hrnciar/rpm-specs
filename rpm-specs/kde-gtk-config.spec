...
* Mon May 11 2020 Rex Dieter <rdieter@fedoraproject.org> - 5.18.5-2
- .spec cleanup, use %%make_build
- drop old/deprecated Obsoletes
...
* Thu Jul 25 2019 Fedora Release Engineering <releng@fedoraproject.org> - 5.16.3-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_31_Mass_Rebuild

* Tue Jul 16 2019 Rex Dieter <rdieter@fedoraproject.org> - 5.16.3-2
- config created by kde-gtk-config forces gtk2 apps to ignore system default fonts (kde#354963)
