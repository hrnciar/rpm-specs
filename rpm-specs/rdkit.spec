...
# TODO: it is bad that rdkit's buildsystem uses CMAKE's FindPostgreSQL because
# that is supposed to find libpq.so installation, not the info about PostgreSQL
# server.  The libpq-devel is used to fill info for PG module build, but it
# might provide completely irrelevant info, see rhbz#1618698.  Partly reported
# here https://github.com/rdkit/rdkit/pull/2014 and also
...
%cmake  -D RDK_INSTALL_INTREE=OFF \
        ...
        -D RDK_BUILD_DESCRIPTORS3D:BOOL=OFF \
...
install -D rdkit--3.7.sql %{buildroot}%{_datadir}/pgsql/extension/rdkit--3.7.sql
popd
popd
...
%files postgresql
%doc python3/Code/PgSQL/rdkit/README
