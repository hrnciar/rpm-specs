...
%global packagename clean-yaml-object
%global enable_tests 0
# tests disabled due to missing 'ava' package in Fedora

Name:		nodejs-clean-yaml-object
Version:	0.1.0
Release:	8%{?dist}
Summary:	Clean up an object prior to serialization

License:	MIT
URL:		https://github.com/tapjs/clean-yaml-object.git
Source0:	https://registry.npmjs.org/%{packagename}/-/%{packagename}-%{version}.tgz
# The test files are not included in the npm tarball.
Source1:	https://raw.githubusercontent.com/tapjs/clean-yaml-object/v%{version}/test.js
...
* Wed Feb  3 2016 Jared Smith <jsmith@fedoraproject.org> - 0.1.0-1
- Initial packaging
