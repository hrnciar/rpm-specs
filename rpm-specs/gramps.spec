...
# Drop these after Fedora 32
Obsoletes:      gramps-webapp < %{version}-%{release}
Provides:       gramps-webapp = %{version}-%{release}
Obsoletes:      gramps-common < %{version}-%{release}
Provides:       gramps-common = %{version}-%{release}
