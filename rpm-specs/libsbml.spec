...
# Unbundle minizip?
# This package needs works for using new minizip >= 2.5.0 (rhbz#1632208).
%if %{with unbundle_minizip}
...
%if %{with python}
find docs/src/filters -type f -name '*.py' -exec pathfix.py -pn -i "%{__python3}"  {} \;
%endif
