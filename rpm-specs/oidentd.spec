...
# doc/book/getting-started/capabilities.md:             GFDL
# doc/book/getting-started/configuration/_index.md:     GFDL
# doc/book/getting-started/configuration/examples.md:   GFDL
# doc/book/getting-started/_index.md:                   GFDL
# doc/book/getting-started/installation.md:             GFDL
# doc/book/getting-started/starting-the-server.md:      GFDL
# doc/book/getting-started/support.md:                  GFDL
# doc/book/guides/_index.md:                            GFDL
# doc/book/guides/using-oidentd-with-quassel.md:        GFDL
# doc/book/guides/using-oidentd-with-znc.md:            GFDL
# doc/book/_index.md:                                   GFDL
# doc/book/nat/forwarding.md:                           GFDL
# doc/book/nat/_index.md:                               GFDL
# doc/book/nat/introduction.md:                         GFDL
# doc/book/nat/static-replies.md:                       GFDL
# doc/book/security/dropping-privileges.md:             GFDL
# doc/book/security/hiding-connections.md:              GFDL
# doc/book/security/identification-vs-authentication.md:    GFDL
# doc/book/security/_index.md:                          GFDL
# doc/oidentd.8:            GFDL
...
# src/missing/getopt_missing.h:     LGPLv2+ (bundled from glibc)
# src/kernel/freebsd.c:     Public Domain
# src/kernel/freebsd4.c:    GPLv2
# src/kernel/freebsd5.c:    Public Domain
# src/kernel/legacy/darwin.c:      BSD
# src/kernel/legacy/netbsd.c:      Public Domain
# src/kernel/legacy/openbsd.c:     Public Domain
# src/kernel/legacy/openbsd24.c:   Public Domain
# src/kernel/legacy/openbsd29.c:   GPLv2
# src/kernel/legacy/solaris4.c:    ??? (something GPL-compatible)
# src/kernel/legacy/solaris5.c:    ??? (something GPL-compatible)
# src/kernel/legacy/solaris7.c:    ??? (something GPL-compatible)
# src/kernel/legacy/solaris8.c:    ??? (something GPL-compatible)
