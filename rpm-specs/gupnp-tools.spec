...
BuildRequires: gssdp-devel >= 0.4.15
...
%{_datadir}/icons/hicolor/256x256/apps/av-cp.png
%{_datadir}/icons/hicolor/256x256/apps/network-light-256x256.png
%{_datadir}/icons/hicolor/256x256/apps/universal-cp.png
