...
# Exclude Python 2 bits until ported, per upstream.
%exclude %{python3_sitelib}/wesnoth/wml*
%exclude %{_datadir}/wesnoth/data/tools/wmlflip
%exclude %{_datadir}/wesnoth/data/tools/scoutDefault.py
%exclude %{_datadir}/wesnoth/data/tools/journeylifter
%exclude %{_datadir}/wesnoth/data/tools/wmlvalidator
%exclude %{_datadir}/wesnoth/data/tools/rmtrans/rmtrans.py
%exclude %{_datadir}/wesnoth/data/tools/wesnoth/wmlparser2.py
%exclude %{_datadir}/wesnoth/data/tools/wesnoth/wmlgrammar.py
%exclude %{_datadir}/wesnoth/data/tools/wesnoth/wmldata.py
%exclude %{_datadir}/wesnoth/data/tools/wesnoth/wmltools.py
%exclude %{_datadir}/wesnoth/data/tools/wesnoth/wmliterator.py
%exclude %{_datadir}/wesnoth/data/tools/wesnoth/wmlparser.py
%exclude %{_datadir}/wesnoth/data/tools/trackplacer
%exclude %{_datadir}/wesnoth/data/tools/expand-terrain-macros.py
