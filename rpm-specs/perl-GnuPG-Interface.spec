...
Patch0:         GnuPG-Interface-0.52-work-with-both-gnupgs.patch
Patch1:         GnuPG-Interface-0.52-gnupg-2.2.6-compatibility.patch
Patch2:         GnuPG-Interface-0.52-gnupg-2.2.8-compatibility.patch
BuildArch:      noarch
BuildRequires:  gpg
