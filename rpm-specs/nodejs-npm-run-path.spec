...
%global packagename npm-run-path
...
Source1:	https://raw.githubusercontent.com/sindresorhus/npm-run-path/v%{version}/test.js

ExclusiveArch:	%{nodejs_arches} noarch
BuildArch:	noarch

BuildRequires:	nodejs-packaging
BuildRequires:	npm(path-key)
%if 0%{?enable_tests}
...
* Wed Apr 19 2017 Jared Smith <jsmith@fedoraproject.org> - 2.0.2-1
- Initial packaging
