...
%if %{with tests}
%check
# test_media_handlers.py requires mujson, which is not packaged in Fedora
PYTHONPATH=%{buildroot}%{python3_sitearch} pytest-%{python3_version} tests --ignore=tests/test_media_handlers.py
%endif
