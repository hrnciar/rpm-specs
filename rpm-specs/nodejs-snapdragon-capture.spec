...
%global packagename snapdragon-capture

# tests disabled until we can bootstrap npm(snapdragon)
%global enable_tests 0

Name:		nodejs-snapdragon-capture
Version:	0.2.0
Release:	8%{?dist}
Summary:	Snapdragon plugin that adds a capture method to the parser instance

License:	MIT
URL:		https://github.com/jonschlinkert/snapdragon-capture
