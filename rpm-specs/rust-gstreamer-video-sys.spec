...
GStreamer (Video library) FFI bindings for Rust.
...
This package contains library source intended for building other packages
which use "v1_0_3" feature of "%{crate}" crate.
...
This package contains library source intended for building other packages
which use "v1_2_2" feature of "%{crate}" crate.
...
* Sun May 05 18:45:00 EEST 2019 Artem Polishchuk <ego.cordatus@gmail.com> - 0.7.0-1
- Initial package
