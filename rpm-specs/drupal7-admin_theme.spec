...
%description
Drupal allows you to define a different theme for administration pages. By
...
* Fri Jun 05 2020 Shawn Iwinski <shawn.iwinski@gmail.com> - 1.1-2
- Bump build requires drupal7-rpmbuild to ">= 7.70-2" to fix F32+ auto provides

* Sun Apr 05 2020 Shawn Iwinski <shawn@iwin.ski> - 1.1-1
...
* Wed May 21 2014 Sam Wilson <sam.wilson@nextdc.com> 1.0-2
* Updated to use module template rather than theme

* Tue May 20 2014 Sam Wilson <sam.wilson@nextdc.com> 1.0-1
- Initial Package (release notes https://drupal.org/node/990228)
