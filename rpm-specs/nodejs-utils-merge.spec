...
Source0:        https://github.com/jaredhanson/utils-merge/archive/v%{version}/%{name}-%{version}.tar.gz
BuildArch:      noarch
...
%prep
%autosetup -n utils-merge-%{version}
rm -rf node_modules
...
* Wed Sep 20 2017 Tom Hughes <tom@compton.nu> - 1.0.1-1
