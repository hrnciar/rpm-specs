...
# CVE-2017-11546 CVE-2017-11547, patches from SUSE
Patch1: timidity-readmidi-zero-division-fix.patch
Patch2: timidity-resample-frac-overflow-fix.patch
...
%prep
%autosetup -p1 -n TiMidity++-2.14.0
