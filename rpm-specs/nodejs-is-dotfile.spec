...
%global packagename is-dotfile
%global enable_tests 1

Name:		nodejs-is-dotfile
Version:	1.0.2
Release:	8%{?dist}
...
Source1:	https://raw.githubusercontent.com/jonschlinkert/is-dotfile/1.0.2/test.js
...
BuildRequires:	npm(dotfile-regex)
%if 0%{?enable_tests}
BuildRequires:	mocha
%endif
...
* Tue Feb  9 2016 Jared Smith <jsmith@fedoraproject.org> - 1.0.2-1
- Initial packaging
