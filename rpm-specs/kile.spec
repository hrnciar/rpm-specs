...
Source0: https://downloads.sourceforge.net/sourceforge/kile/kile-%{version}%{?pre}.tar.bz2
...
%check
appstream-util validate-relax --nonet %{buildroot}%{_kf5_metainfodir}/org.kde.kile.appdata.xml
desktop-file-validate %{buildroot}%{_kf5_datadir}/applications/org.kde.kile.desktop
...
%license COPYING
%{_kf5_sysconfdir}/xdg/kile.*
%{_kf5_bindir}/kile
%{_kf5_libdir}/libkdeinit5_kile.so
%{_kf5_datadir}/config.kcfg/kile.kcfg
%{_kf5_datadir}/kconf_update/*
%{_kf5_datadir}/kile/
%{_kf5_datadir}/applications/org.kde.kile.desktop
%{_kf5_metainfodir}/org.kde.kile.appdata.xml
%{_kf5_datadir}/dbus-1/interfaces/net.sourceforge.kile.main.xml
%{_kf5_datadir}/icons/hicolor/*/*/*
%{_kf5_datadir}/mime/packages/kile.xml
