...
%global packagename conventional-changelog-eslint

# tests fail and timeout in mock/koji, but run fine locally
%global enable_tests 0

Name:		nodejs-conventional-changelog-eslint
Version:	1.0.9
Release:	5%{?dist}
Summary:	A conventional-changelog eslint preset
...
* Sat Mar 31 2018 Jared Smith <jsmith@fedoraproject.org> - 1.0.9-1
- Initial packaging
