...
cp -pr package.json aws4.js lru.js \
...
%{__nodejs} -e 'require("./")'
%if 0%{?enable_tests}
%{_bindir}/mocha ./test/fast.js ./test/slow.js -b -t 100s -R list
%else
...
* Thu Dec 14 2017 Jared Smith <jsmith@fedoraproject.org> - 1.6.0-1
- Initial packaging
