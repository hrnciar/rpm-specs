...
Patch03:        0001-Dont-use-subscript.patch
...
f="desktop/recoll-searchgui.desktop"
iconv -f ISO_8859-1 -t utf-8 -o $f.utf8 $f
mv $f.utf8 $f
...
%{_datadir}/dbus-1/services/org.recoll.Recoll.service
