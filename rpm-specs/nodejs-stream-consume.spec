...
%global packagename stream-consume
%global enable_tests 1

Name:		nodejs-stream-consume
Version:	0.1.0
Release:	11%{?dist}
...
awk '/## License/,0' README.md > LICENSE
...
* Wed Feb 03 2016 Jared Smith <jsmith@fedoraproject.org> - 0.1.0-2
- Fix build requirements for tests

* Wed Jan 20 2016 Jared Smith <jsmith@fedoraproject.org> - 0.1.0-1
- Initial packaging
