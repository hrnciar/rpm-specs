...
%global packagename thread-sleep
%global enable_tests 1

Name:		nodejs-thread-sleep
Version:	2.0.0
Release:	6%{?dist}
Summary:	A module for when you just need node to back off for a few milliseconds

License:	MIT
URL:		https://github.com/ForbesLindesay/thread-sleep
...
* Fri Sep 29 2017 Jared Smith <jsmith@fedoraproject.org> - 2.0.0-1
- Initial packaging
