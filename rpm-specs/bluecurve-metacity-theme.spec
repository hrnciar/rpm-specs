...
%files
%doc AUTHORS COPYING
# We own the the entire theme dir instead of just metacity-1
# to prevent a circular dependency on bluecurve-gnome-theme
...
- Fix FTBFS in rawhide rhbz #1307355 plus spec cleanup
