...
Source0:        https://github.com/gap-packages/Digraphs/releases/download/v%{version}/%{pkgname}-%{version}.tar.gz
...
rm -fr extern/edge-addition-planarity-suite-Version_3.0.0.5
...
cp -a bin data gap tst VERSION* *.g \
