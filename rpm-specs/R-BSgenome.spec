...
BuildRequires:    R-GenomeInfoDb >= 1.23.9 R-GenomicRanges >= 1.31.10 R-Biostrings-devel >= 2.47.6
BuildRequires:    R-rtracklayer >= 1.39.7
BuildRequires:    R-methods R-utils R-stats R-matrixStats R-XVector-devel R-Rsamtools
