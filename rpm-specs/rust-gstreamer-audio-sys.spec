...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-audio-1.0) >= 1.0
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-audio-1.0) >= 1.10
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-audio-1.0) >= 1.12
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-audio-1.0) >= 1.2
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-audio-1.0) >= 1.4
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-audio-1.0) >= 1.6
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-audio-1.0) >= 1.8
...
echo 'pkgconfig(gstreamer-audio-1.0) >= 1.0'
...
* Sun May 05 19:47:40 EEST 2019 Artem Polishchuk <ego.cordatus@gmail.com> - 0.7.0-1
- Initial package
