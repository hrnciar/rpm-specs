...
%check
# The deselected tests are failing with 3.9.0b1+ due to whitespace differences: https://github.com/PyCQA/pyflakes/issues/549
%pytest -k "not (test_invalidEscape or test_nonDefaultFollowsDefaultSyntaxError or test_nonKeywordAfterKeywordSyntaxError)"
