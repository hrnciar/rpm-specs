...
%global packagename base32-encode
%global enable_tests 1

Name:		nodejs-base32-encode
Version:	0.1.0
Release:	6%{?dist}
Summary:	Base32 encoder with support for multiple variants.

License:	MIT
URL:		https://github.com/linusu/base32-encode
Source0:	https://registry.npmjs.org/%{packagename}/-/%{packagename}-%{version}.tgz
# license file requested at https://github.com/LinusU/base32-encode/issues/1
