...
License:            MIT
URL:                https://www.npmjs.org/package/rainbowsocks
...
%install
mkdir -p %{buildroot}%{nodejs_sitelib}/rainbowsocks
cp -pr package.json test.js index.js \
    %{buildroot}%{nodejs_sitelib}/rainbowsocks
