...
%global packagename arr-exclude

# tests missing due to missing npm(ava)
%global enable_tests 0

Name:		nodejs-arr-exclude
Version:	1.0.0
Release:	9%{?dist}
Summary:	Exclude certain items from an array

License:	MIT
URL:		https://github.com/sindresorhus/arr-exclude
Source0:	https://registry.npmjs.org/%{packagename}/-/%{packagename}-%{version}.tgz
# The test files are not included in the npm tarball.
Source1:	https://raw.githubusercontent.com/sindresorhus/arr-exclude/v%{version}/test.js
...
* Thu Apr 20 2017 Jared Smith <jsmith@fedoraproject.org> - 1.0.0-1
- Initial packaging
