...
%global packagename buf-compare
%global enable_tests 0
# tests disabled until npm(ava) is packaged in Fedora

Name:		nodejs-buf-compare
Version:	1.0.0
Release:	8%{?dist}
Summary:	Node.js 0.12 Buffer.compare() ponyfill

License:	MIT
URL:		https://github.com/sindresorhus/buf-compare
Source0:	https://registry.npmjs.org/%{packagename}/-/%{packagename}-%{version}.tgz
# The test files are not included in the npm tarball.
Source1:	https://raw.githubusercontent.com/sindresorhus/buf-compare/v1.0.0/test.js
...
* Mon Nov  9 2015 Jared Smith <jsmith@fedoraproject.org> - 1.0.0-1
- Initial packaging
