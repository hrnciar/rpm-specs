...
# uintptr_t now in stdint.h, this patch is upstream.
Patch001:	monitor-edid-uintptr_t.patch

# fix make tests
Patch002:	return-monitorsdb.patch

# fix double include
Patch003:	Avoid-double-include.patch
Patch004:	dual-verbose.diff
