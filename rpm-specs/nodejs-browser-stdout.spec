...
%global packagename browser-stdout
%global enable_tests 1

Name:		nodejs-browser-stdout
Version:	1.3.0
Release:	8%{?dist}
Summary:	A process.stdout for your browser

License:	ISC
URL:		https://github.com/kumavis/browser-stdout
Source0:	https://registry.npmjs.org/%{packagename}/-/%{packagename}-%{version}.tgz
# No license file upstream, requested at https://github.com/kumavis/browser-stdout/issues/3
...
%changelog
* Sat Aug 01 2020 Fedora Release Engineering <releng@fedoraproject.org> - 1.3.0-8
- Second attempt - Rebuilt for
  https://fedoraproject.org/wiki/Fedora_33_Mass_Rebuild

* Tue Jul 28 2020 Fedora Release Engineering <releng@fedoraproject.org> - 1.3.0-7
...
* Wed Sep 20 2017 Jared Smith <jsmith@fedoraproject.org> - 1.3.0-1
- Initial packaging
